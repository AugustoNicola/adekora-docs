...
However, Adèkora uses the **Absolutive** case (what "would be" the nominative) for the **subject of intransitive verbs** and **direct objects**, whereas the **Ergative** case is used *only* for **subjects of transitive verbs**. 
